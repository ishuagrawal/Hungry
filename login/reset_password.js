...
document.querySelector('form').onsubmit = function(event) {
    ...
    let oldPassword = document.querySelector("#old-password-id").value.trim();
    let newPassword = document.querySelector("#new-password-id").value.trim();
    ...
    if ( oldPassword.length == 0 ) {
        document.querySelector('#old-password-id').classList.add('is-invalid');
    } else {
        document.querySelector('#old-password-id').classList.remove('is-invalid');
    }

    if ( newPassword.length == 0 ) {
        document.querySelector('#new-password-id').classList.add('is-invalid');
    } else {
        document.querySelector('#new-password-id').classList.remove('is-invalid');
    }
    ...
    if (document.querySelectorAll('.is-invalid').length == 0) {
        ...
        ajaxPost("reset_password_results.php", postData, function(response) {
